...
import PlantAnatomy from '../EcoImpact/PlantAnatomy';
import '../../css/plantDetective.css';
...
const PlantDetective = ({ showNotification, user }) => {
    const [mode, setMode]               = useState('detective'); // 'detective' | 'anatomy'
    ...
    return (
        <div className="pdet-page">
            {/* Top-level mode tabs: Detective vs Plant Anatomy */}
            <div className="pdet-mode-tabs">
                <button
                    className={`pdet-mode-tab ${mode === 'detective' ? 'active' : ''}`}
                ...
                <button
                    className={`pdet-mode-tab ${mode === 'anatomy' ? 'active' : ''}`}
                    onClick={() => setMode('anatomy')}
                >
                    <i className="fas fa-microscope"></i>
                    <span>Plant Anatomy</span>
                </button>
            </div>
