...
// Popis korisnikovih biljaka s pretragom i filtrima
const MyPlants = ({ showNotification, user, onShowPlantDetails }) => {
              ...
              {filteredPlants.map(plant => (
                <div key={plant.id} className="plant-card">
                  <div className="plant-card-image">
                    ...
                    <div className="no-image" style={{ display: (plant.image_url || plant.image) ? 'none' : 'flex' }}>
                      <i className="fas fa-seedling"></i>
                    </div>
                    ...
                    <div className="plant-details">
                      ...
                      {cleanText(plant.description) && (
                        <p className="plant-description">
                          {cleanText(plant.description).length > 100
                            ? `${cleanText(plant.description).substring(0, 100)}...`
                            : cleanText(plant.description)
                          }
                        </p>
                      )}
