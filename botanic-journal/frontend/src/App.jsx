// Glavna komponenta aplikacije - upravlja navigacijom izmedu prikaza
...
function App() {
  ...
  const renderContent = () => {
    ...
    switch (activeView) {
      ...
      case 'garden-map':
        return <GardenMapDesigner showNotification={showNotification} user={currentUser} onShowPlantDetails={showPlantDetails} />;
      case 'gardeners':
        return <Gardeners
          showNotification={showNotification}
