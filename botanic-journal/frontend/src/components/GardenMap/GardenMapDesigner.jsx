...
import LiveGarden from '../LiveGarden/LiveGarden';
import '../../css/gardenMap.css';
...
const GardenMapDesigner = ({ showNotification, onShowPlantDetails }) => {
  const [mode, setMode]             = useState('designer'); // 'designer' | 'live'
  ...
  return (
    <div className="gm-container">
      <div className="gm-mode-tabs">
        <button
          className={`gm-mode-tab ${mode === 'designer' ? 'active' : ''}`}
        ...
        <button
          className={`gm-mode-tab ${mode === 'live' ? 'active' : ''}`}
