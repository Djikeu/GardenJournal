...
const AnalyticsChart = ({ showNotification }) => {
  ...
  if (loading) return (
    <div className="ac-card" style={s.card}>
      <div style={s.cardHeader}><span className="ac-card-title" style={s.cardTitle}>Plant Analytics</span></div>
  ...
  return (
    <div className="ac-card" style={s.card}>
      ...
      <div style={s.cardHeader}>
        <div>
          <span className="ac-card-title" style={s.cardTitle}>Plant Analytics</span>
      ...
      <div style={s.statsGrid}>
        {stats.map((st, i) => (
          <div key={i} className="ac-statcard" style={s.statCard}>
      ...
      <div className="ac-section" style={s.section}>
        <div style={s.sectionHeader}>
          <span className="ac-section-title" style={s.sectionTitle}>Plants added — last 30 days</span>
      ...
      <div style={s.bottomRow}>
        ...
        <div className="ac-minicard" style={s.miniCard}>
          <span className="ac-section-title" style={s.sectionTitle}>Plants by type</span>
        ...
        <div className="ac-minicard" style={s.miniCard}>
          <div style={s.sectionHeader}>
            <span className="ac-section-title" style={s.sectionTitle}>Upcoming tasks — 14 days</span>
            {totalUpcoming > 0 && (
